...
export const metadata = {
  ...
  description:
    "Бухгалтерское сопровождение ИП и ТОО в Алматы: налоговые консультации, отчетность, декларации, зарплата, первичные документы, восстановление учета и сопровождение в ЕСУТД.",
  keywords: [
    ...
    "Алматы бухгалтерлік қызметтер",
    "бухгалтерлік қызмет Алматы",
    "бухгалтерлік сүйемелдеу",
    "ЖК бухгалтериясы",
    "ЖШС бухгалтериясы",
    "Қазақстандағы бухгалтер",
    "Алматыдағы бухгалтер",
    "салық консультациясы Алматы",
    "салық есептілігі",
    "декларация тапсыру",
    ...
    "Тастақ бухгалтерия",
    "БТҚБЖ сүйемелдеу",
    "электрондық жол парақтары",
    "ЭТТН Қазақстан",
    "accounting services Almaty",
    "accounting support Almaty",
    "bookkeeping services Kazakhstan",
    "bookkeeping Almaty",
    "accountant in Almaty",
    "accountant for business Kazakhstan",
    "accounting for sole proprietors Kazakhstan",
    "accounting for LLP Kazakhstan",
    "tax consultation Almaty",
    "tax reporting Kazakhstan",
    "tax declarations Almaty",
    "payroll calculation Kazakhstan",
    "accounting outsourcing Almaty",
    "accounting recovery Almaty",
    "primary accounting documents",
    "ESUTD support Kazakhstan",
    "electronic waybills Kazakhstan",
    "e-consignment notes Kazakhstan",
  ],
  ...
  openGraph: {
    ...
    description:
      "Бухгалтерское сопровождение ИП и ТОО в Алматы: налоги, отчетность, декларации, зарплата, восстановление учета и сопровождение в ЕСУТД.",
    url: "/",
    locale: "ru_KZ",
    type: "website",
