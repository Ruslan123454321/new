        ...
        <section className="esutd section" id="esutd">
          <div className="section-shell">
            <div className="esutd-hero">
              <div>
                <p className="eyebrow">ЕСУТД для грузоперевозчиков</p>
                <h2>Комплексное сопровождение в системе транспортных документов</h2>
              </div>
              <p>
                Вы владелец автопарка или индивидуальный предприниматель, которому нужно работать в
                Единой системе управления транспортными документами? Поможем настроить процессы
                быстро, корректно и в полном соответствии с законодательством Республики Казахстан.
              </p>
            </div>

            <div className="esutd-grid">
              {esutdServices.map((service) => (
            ...
            <div className="esutd-bottom">
              <div>
                <p className="eyebrow dark">Почему выбирают нас</p>
                <h3>Решения без громоздкой бюрократии</h3>
                <p>
                  Мы знаем специфику малого бизнеса в сфере логистики и предлагаем только то, что
                  нужно вашему бизнесу здесь и сейчас.
                </p>
              </div>
              <div className="esutd-benefits">
                {esutdBenefits.map((benefit) => (
